function [sol,incre,increfx,iter,ACOC,x] = WF4orden(f,x0,tol,maxiter)
% Generalización del método de Weerakoon y Fernando a orden 4
%Ejemplo de ejecución en consola:
%[sol,incre,increfx,iter,ACOC,x] = WF4orden('f',0.5,1e-40,500)
...
while incre+increfx > tol && iter < maxiter
    ...
    [~,dfuny]=feval(f,y);
    t=dfuny/dfun;
    x1=x0-(3/4*t^2-7/4*t+2)*2*fun/(dfun+dfuny);
    incre = norm(x1-x0);
